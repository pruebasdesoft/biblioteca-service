...
public class Book {
  ...
  @ApiModelProperty("Clave primaria de la entidad.")
  private Long id;
  private String title;
  private String author;
  private Integer pages;
  @ApiModelProperty("Precio en dolares, con 2 decimales.")
  private Double price;
  private LocalDate releaseDate;
  @ApiModelProperty("Indicador si está disponible por internet.")
